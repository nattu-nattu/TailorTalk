...
def get_calendar_availability(user_email: str, start_time: str, end_time: str, credentials_path=None) -> List[Dict[str, Any]]:
    """
    ...
    Args:
        ...
        credentials_path (str): Path to credentials.json (from st.secrets if on Streamlit Cloud)
    Returns:
